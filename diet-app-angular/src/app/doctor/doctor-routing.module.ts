...
const doctorRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'diet/:idPatient/:idDiet/assign-meals', component: DietMealsComponent },
      { path: 'diet/:idPatient/:idDiet/meals', component: DietMealsListComponent },
      ...
      { path: 'patients/:idPatient/report', component: ReportComponent },
